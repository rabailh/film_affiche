...
package talend.call_script_1_0;
 ...
 * @status
 */
public class call_script implements TalendJob {
	...
	private final String jobName = "call_script";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(call_script.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tSystem_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final Process ps_tSystem_1 = runtime_tSystem_1.exec("python3 script/script.py", env_tSystem_1);
	...
	public static void main(String[] args) {
		final call_script call_scriptClass = new call_script();

		int exitCode = call_scriptClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = call_script.class.getClassLoader()
					.getResourceAsStream("talend/call_script_1_0/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = call_script.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : call_script");
		}
...
/************************************************************************************************
 * 28003 characters generated by Talend Open Studio for Data Integration on the
 * 26 janvier 2024, 09:10:34 CET
 ************************************************************************************************/