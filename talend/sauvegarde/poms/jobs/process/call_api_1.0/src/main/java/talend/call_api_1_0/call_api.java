...
class DeleteFoldertFileDelete_1{
    ...
    java.io.File file_tFileDelete_1=new java.io.File("D:/Applications/TOS_DI-8.0.1/studio/workspace/FILM/_output/film_affiche.csv");
	...
	globalMap.put("tFileDelete_1_DELETE_PATH","D:/Applications/TOS_DI-8.0.1/studio/workspace/FILM/_output/film_affiche.csv");
...
public static class film2Struct implements routines.system.IPersistableRow<film2Struct> {
    final static byte[] commonByteArrayLock_TALEND_call_api = new byte[0];
    static byte[] commonByteArray_TALEND_call_api = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TALEND_call_api.length) {
				if(length < 1024 && commonByteArray_TALEND_call_api.length == 0) {
   					commonByteArray_TALEND_call_api = new byte[1024];
				} else {
   					commonByteArray_TALEND_call_api = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TALEND_call_api, 0, length);
			strReturn = new String(commonByteArray_TALEND_call_api, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_TALEND_call_api, 0, length);
			strReturn = new String(commonByteArray_TALEND_call_api, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TALEND_call_api) {
 ...
 */
	...
	java.util.Map<String, Object> headers_tREST_1 = new java.util.HashMap<String, Object>();
    	...
    	headers_tREST_1.put("Authorization","Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI2ZDA2OGNiNzdmMDdiYWQ1NjQ4YmVjNzMyZDdjZmU4MiIsInN1YiI6IjY1YThkZTc3MGU1YWJhMDEzODdkZTIwOSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.EDcWYM5XLM8Ku9ab4qhMOhwFnNaJqoIykiFCW6KT_6Q");
...
;
		...
		try {
				...
				if(value_tExtractJSONFields_1 != null && !value_tExtractJSONFields_1.toString().isEmpty()) {
					films2.adult = ParserUtils.parseTo_Boolean(value_tExtractJSONFields_1.toString());
				} else {
					films2.adult = 
...
;
		...
		try {
				...
				if(value_tExtractJSONFields_1 != null && !value_tExtractJSONFields_1.toString().isEmpty()) {
					films2.vote_average = ParserUtils.parseTo_Float(value_tExtractJSONFields_1.toString());
				} else {
					films2.vote_average = 
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("D:/Applications/TOS_DI-8.0.1/studio/workspace/FILM/_output/film_affiche.csv")).getAbsolutePath().replace("\\","/");
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, true),"UTF-8"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        ...
                                        outtFileOutputDelimited_1.write("original_language");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("original_title");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("title");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("overview");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("poster_path");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("production_companies");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("release_date");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        ...
                                        outtFileOutputDelimited_1.write("vote_count");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("tagline");
 ...
 */
	...
	String endpoint_tREST_2 = "https://api.themoviedb.org/3/movie/"+globalMap.get("films2.id")+"?language=fr-FR";
	...
	java.util.Map<String, Object> headers_tREST_2 = new java.util.HashMap<String, Object>();
    	...
    	headers_tREST_2.put("Authorization","Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI2ZDA2OGNiNzdmMDdiYWQ1NjQ4YmVjNzMyZDdjZmU4MiIsInN1YiI6IjY1YThkZTc3MGU1YWJhMDEzODdkZTIwOSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.EDcWYM5XLM8Ku9ab4qhMOhwFnNaJqoIykiFCW6KT_6Q");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = call_api.class.getClassLoader().getResourceAsStream("talend/call_api_1_0/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = call_api.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
/************************************************************************************************
 *     124877 characters generated by Talend Open Studio for Data Integration 
 *     on the 26 janvier 2024, 09:07:53 CET
 ************************************************************************************************/