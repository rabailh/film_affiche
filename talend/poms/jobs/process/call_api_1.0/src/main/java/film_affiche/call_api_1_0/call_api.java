...
package film_affiche.call_api_1_0;
...
public class call_api implements TalendJob {
	...
	private final String projectName = "FILM_AFFICHE";
	...
	public void tIterateToFlow_1_ITFO_error(Exception exception, String errorComponent,
		...
		tIterateToFlow_1_AI_error(exception, errorComponent, globalMap);
	...
	public void tIterateToFlow_1_AI_error(Exception exception, String errorComponent,
		...
		tIterateToFlow_1_ITFO_onSubJobError(exception, errorComponent, globalMap);
	}
	...
	public void tIterateToFlow_1_ITFO_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_FILM_AFFICHE_call_api = new byte[0];
		static byte[] commonByteArray_FILM_AFFICHE_call_api = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FILM_AFFICHE_call_api.length) {
					if (length < 1024 && commonByteArray_FILM_AFFICHE_call_api.length == 0) {
						commonByteArray_FILM_AFFICHE_call_api = new byte[1024];
					} else {
						commonByteArray_FILM_AFFICHE_call_api = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FILM_AFFICHE_call_api, 0, length);
				strReturn = new String(commonByteArray_FILM_AFFICHE_call_api, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_FILM_AFFICHE_call_api, 0, length);
				strReturn = new String(commonByteArray_FILM_AFFICHE_call_api, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FILM_AFFICHE_call_api) {
	...
	public void tREST_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_2.addRow(new String[] { "id", "title", "original_title", "release_date",
						"original_language", "genre_ids", "overview", "adult", "poster_path", "vote_average", });
...
// Start of branch "row2"
						if (row2 != null) {
							...
							row5.original_title = row2.original_title;
							row5.release_date = row2.release_date;
							row5.original_language = row2.original_language;
							row5.genre_ids = row2.genre_ids;
							row5.overview = row2.overview;
							row5.adult = row2.adult;
							row5.poster_path = row2.poster_path;
							row5.vote_average = row2.vote_average;
...
///////////////////////    			
							...
							String endpoint_tREST_2 = "https://api.themoviedb.org/3/movie/" + globalMap.get("row1.id")
									+ "?language=fr-FR";
...
///////////////////////		
							...
							if (row1.Body != null) { //
								row_tLogRow_1[0] = String.valueOf(row1.Body);

							} //

							if (row1.ERROR_CODE != null) { //
								row_tLogRow_1[1] = String.valueOf(row1.ERROR_CODE);
...
///////////////////////		
							...
							if (row5.original_title != null) { //
								row_tLogRow_2[2] = String.valueOf(row5.original_title);

							} //

							if (row5.release_date != null) { //
								row_tLogRow_2[3] = String.valueOf(row5.release_date);

							} //

							if (row5.original_language != null) { //
								row_tLogRow_2[4] = String.valueOf(row5.original_language);

							} //

							if (row5.genre_ids != null) { //
								row_tLogRow_2[5] = String.valueOf(row5.genre_ids);

							} //

							if (row5.overview != null) { //
								row_tLogRow_2[6] = String.valueOf(row5.overview);

							} //

							if (row5.adult != null) { //
								row_tLogRow_2[7] = String.valueOf(row5.adult);

							} //

							if (row5.poster_path != null) { //
								row_tLogRow_2[8] = String.valueOf(row5.poster_path);

							} //

							if (row5.vote_average != null) { //
								row_tLogRow_2[9] = FormatterUtils.formatUnwithE(row5.vote_average);
...
///////////////////////    			
	...
	public static class OnSubjobOkStructtIterateToFlow_1
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final OnSubjobOkStructtIterateToFlow_1 other = (OnSubjobOkStructtIterateToFlow_1) obj;
		...
		public void copyDataTo(OnSubjobOkStructtIterateToFlow_1 other) {

			other.id = this.id;

		}

		public void copyKeysDataTo(OnSubjobOkStructtIterateToFlow_1 other) {
	...
	public void tIterateToFlow_1_ITFOProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		globalMap.put("tIterateToFlow_1_ITFO_SUBPROCESS_STATE", 0);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				struct_tIterateToFlow_1_ITFO.id = "906126";
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tIterateToFlow_1_ITFO:OnSubjobOk", "",
		...
		globalMap.put("tIterateToFlow_1_ITFO_SUBPROCESS_STATE", 1);
	}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = call_api.class.getClassLoader()
					.getResourceAsStream("film_affiche/call_api_1_0/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 139441 characters generated by Talend Open Studio for Data Integration on the
 * 18 janvier 2024, 12:05:47 CET
 ************************************************************************************************/