...
public class main implements TalendJob {
	...
	public static class modelisation1Struct implements routines.system.IPersistableRow<modelisation1Struct> {
		final static byte[] commonByteArrayLock_TALEND_main = new byte[0];
		static byte[] commonByteArray_TALEND_main = new byte[0];

		public void readData(ObjectInputStream dis) {

			synchronized (commonByteArrayLock_TALEND_main) {
		 ...
		 * Compare keys
		 */
		public int compareTo(modelisation1Struct other) {
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				modelisation1Struct modelisation1 = new modelisation1Struct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "modelisation1");
				}
				...
				talend.call_api_1_0.call_api childJob_tRunJob_3 = new talend.call_api_1_0.call_api();
				// pass DataSources
				...
				for (String[] item_tRunJob_3 : childReturn_tRunJob_3) {
					...
					talend.call_script_1_0.call_script childJob_tRunJob_1 = new talend.call_script_1_0.call_script();
					// pass DataSources
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "modelisation1");
				}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = main.class.getClassLoader()
					.getResourceAsStream("talend/main_1_0/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 37404 characters generated by Talend Open Studio for Data Integration on the
 * 26 janvier 2024, 09:07:54 CET
 ************************************************************************************************/